...
CREATE TABLE users (id INT AUTO_INCREMENT, firstname VARCHAR(50), lastname VARCHAR(50), username VARCHAR(50) UNIQUE NOT NULL, hashedpassword varchar(100), email varchar(50), PRIMARY KEY(id));
